...
/*  This program presents a menu of choices (three different decades), gets the user's choice, and then presents a
secondary menu (sports, entertainment, and politics).
...
#include <stdlib.h>  // the header file for the exit(),

int main()

{
    // Despite being a long program, you only need two variables: one for the first menu and one for the second one
    ...
    do
    {
        ...
        // In the first case, the user picked the 1980s.Now it is time to see what specific info they need.
...

        {
            ...
            {
                printf("\n\nOscar-Winning Movie in the 1980s:\n");
                printf("1980: Ordinnary People\n");
