...
It tests
whether their password has an uppercase letter, lowercase letter and a digit. If it does, the program congratulates their selection.
...

{
    ...
    // This loop goes through each character of the password and tests whether it is a digit, uppercase letter, then lowercase letter.
    ...
    /* The if portion will only execute if all three variables below are 1, and the variables will only equal 1 if the
    appropriate characters were each found */
